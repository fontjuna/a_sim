...
class TableColumns:     # 테이블 데이타 컬럼 정의
    ...
    hd주문진행목록 = {
        ...
        '정수': ['주문수량', '주문가격', '체결수량', '미체결수량', '주문가능수량'],
        '실수': [],
        '컬럼': ['종목코드', '구분', '상태', '종목명', '주문번호', '주문가격', '주문수량', '체결수량', '미체결수량', '주문가능수량', '요청명', '비고'],
        '헤더': ['구분', '상태', '종목코드', '종목명', '주문가격', '주문수량', '체결수량', '미체결수량', '주문가능수량', '비고'],
    }
