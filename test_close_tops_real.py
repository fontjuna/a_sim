...
def test_close_tops_real():
    """실제 날짜를 사용한 get_close_tops 함수 테스트"""
    print("=== 실제 날짜를 사용한 get_close_tops 함수 테스트 ===\n")
    ...
    for n, cnt, m, desc in test_cases:
        ...
        print(f"  OldChartManager: {ocm_result}")
